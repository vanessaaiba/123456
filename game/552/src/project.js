          ...
          , p = function(e) {
            ...
            t.prototype.onTouchEnd = function(e) {
                ...
                this.scheduleOnce(function() {
                    ...
                    t.createFruitCount++) : t.createFruitCount > 5 && (a.default.Instance.createOneFruit(s.default.RandomInteger(5, 10)),
                    t.createFruitCount++))
                }, .5))
            }
            ,
          ...
          , m = function(e) {
            ...
            t.prototype.onBeginContact = function(e, t, n) {
                ...
                "fruit" == n.node.group) {
                    ...
                    n.node.getComponent(cc.PhysicsCircleCollider).restitution=0.6,
                    n.node.getComponent(cc.PhysicsCircleCollider).apply(),
                    this.node.getComponent(cc.PhysicsCircleCollider).radius = 0,
                    this.node.getComponent(cc.PhysicsCircleCollider).restitution=0.6,
